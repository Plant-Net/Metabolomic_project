Brain Cancer: High dimensional discriminant analysis (HDDA) with
selected features
================
Justine LABORY
2023-09-15
...
```
    ...
    ## [1] "Mean Accuracy : 84.2 (±8.3)"
    ## [1] "Mean Balanced accuracy : 82.7 (7.9)"
    ## [1] "Mean Precision : 82.1 (±6.3)"
    ## [1] "Mean Recall : 91.6 (±9.8)"
    ## [1] "Mean F1 score : 86.5 (±7.4)"
    ## [1] "Mean ROC AUC : 83.4 (±9.5)"
    ## [1] "Mean Specificity : 73.9 (±9.3)"
...
```
    ...
    ## [1] "Accuracy 95% CI: [74.4 ; 90.9]"
    ## [1] "Balanced accuracy 95% CI: [73 ; 88.9]"
    ## [1] "Precision 95% CI: [74 ; 86.7]"
    ## [1] "Recall 95% CI: [82 ; 100]"
    ## [1] "F1 score 95% CI: [78.8 ; 92.9]"
    ## [1] "ROC AUC 95% CI: [70.5 ; 89.1]"
    ## [1] "Specificity 95% CI: [61.3 ; 79.8]"
