BREAST Cancer: Gaussian processes (GPLVM) on selected features
================
Justine LABORY
2023-09-15
...
```
    ...
    ## [1] "Mean Accuracy : 85.2 (±2.1)"
    ## [1] "Mean Balanced accuracy : 71.6 (4.8)"
    ## [1] "Mean Precision : 84.5 (±2.3)"
    ## [1] "Mean Recall : 98.5 (±1.9)"
    ## [1] "Mean F1 score : 91 (±1.2)"
    ## [1] "Mean ROC AUC : 90 (±2.8)"
    ## [1] "Mean Specificity : 44.7 (±10.7)"
...
```
    ...
    ## [1] "Accuracy 95% CI: [83.8 ; 88]"
    ## [1] "Balanced accuracy 95% CI: [67.7 ; 77.9]"
    ## [1] "Precision 95% CI: [82.4 ; 87.5]"
    ## [1] "Recall 95% CI: [96.2 ; 100]"
    ## [1] "F1 score 95% CI: [89.9 ; 92.5]"
    ## [1] "ROC AUC 95% CI: [87.4 ; 92.8]"
    ## [1] "Specificity 95% CI: [35.5 ; 57.9]"
