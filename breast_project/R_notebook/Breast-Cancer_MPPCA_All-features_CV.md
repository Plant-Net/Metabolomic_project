Breast Cancer: Run Mixture of PPCA (MPPCA) on all features
================
Justine LABORY
2023-09-15
...
```
    ...
    ## [1] "Mean Accuracy : 83.8 (±3.2)"
    ## [1] "Mean Balanced accuracy : 77.8 (4.4)"
    ## [1] "Mean Precision : 88.9 (±2.6)"
    ## [1] "Mean Recall : 89.7 (±3.3)"
    ## [1] "Mean F1 score : 89.3 (±2.1)"
    ## [1] "Mean ROC AUC : 86.6 (±3.7)"
    ## [1] "Mean Specificity : 65.8 (±8.3)"
...
```
    ...
    ## [1] "Accuracy 95% CI: [81 ; 87.9]"
    ## [1] "Balanced accuracy 95% CI: [73.6 ; 82.2]"
    ## [1] "Precision 95% CI: [86.6 ; 91.6]"
    ## [1] "Recall 95% CI: [86.4 ; 93.8]"
    ## [1] "F1 score 95% CI: [87.5 ; 92.1]"
    ## [1] "ROC AUC 95% CI: [82 ; 90]"
    ## [1] "Specificity 95% CI: [58.8 ; 74.7]"
