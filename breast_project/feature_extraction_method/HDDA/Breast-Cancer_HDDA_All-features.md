Breast Cancer: Run High dimensional discriminant analysis (HDDA) on all
features
================
Justine LABORY
2023-09-15
...
```
    ...
    ## [1] "Mean Accuracy : 84.1 (±2.5)"
    ## [1] "Mean Balanced accuracy : 79 (3.7)"
    ## [1] "Mean Precision : 89.7 (±2.2)"
    ## [1] "Mean Recall : 89.2 (±2.5)"
    ## [1] "Mean F1 score : 89.4 (±1.7)"
    ## [1] "Mean ROC AUC : 86 (±3.2)"
    ## [1] "Mean Specificity : 68.8 (±6.9)"
...
```
    ...
    ## [1] "Accuracy 95% CI: [81.1 ; 86.7]"
    ## [1] "Balanced accuracy 95% CI: [74 ; 81.3]"
    ## [1] "Precision 95% CI: [86.8 ; 91.6]"
    ## [1] "Recall 95% CI: [86.4 ; 92]"
    ## [1] "F1 score 95% CI: [87.5 ; 91.2]"
    ## [1] "ROC AUC 95% CI: [82 ; 89.2]"
    ## [1] "Specificity 95% CI: [59.7 ; 74.7]"
